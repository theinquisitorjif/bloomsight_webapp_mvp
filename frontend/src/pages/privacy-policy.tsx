  ...
  return (
    <div className="flex flex-col items-center pt-10 pb-20">
      <main className="container p-2 xl:max-w-[1000px] space-y-4">
        ...
        <h3 className="!text-xl font-medium border-l-4 border-green-300 pl-4">
          Interpretation
        </h3>
        <p>
        ...
        <ul className="bg-neutral-100 p-4 rounded-lg flex flex-col gap-2">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Alarex, Gainesville, FL 32611.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Bloomsight, accessible from{" "}
              <a
                href="bloomsight.com"
        ...
        <h4 className="!text-xl font-medium">Personal Data</h4>
        <p>
        ...
        <h4 className="!text-xl font-medium">Usage Data</h4>
        ...
        <h4 className="!text-xl font-medium">Business Transactions</h4>
        <p>
        ...
        <h4 className="!text-xl font-medium">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="!text-xl font-medium">Other legal requirements</h4>
        <p>
